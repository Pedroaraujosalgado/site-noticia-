...
class IndicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create index" do
    assert_difference('Index.count') do
      post indices_url, params: { index: { categoria_id: @index.categoria_id, data_hora: @index.data_hora, titulo_id: @index.titulo_id, usuario_id: @index.usuario_id } }
    end
  ...
  test "should update index" do
    patch index_url(@index), params: { index: { categoria_id: @index.categoria_id, data_hora: @index.data_hora, titulo_id: @index.titulo_id, usuario_id: @index.usuario_id } }
