...
class NoticiaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create noticium" do
    assert_difference('Noticium.count') do
      post noticia_url, params: { noticium: { texto: @noticium.texto, titulo: @noticium.titulo, usuario_id: @noticium.usuario_id } }
    end
  ...
  test "should update noticium" do
    patch noticium_url(@noticium), params: { noticium: { texto: @noticium.texto, titulo: @noticium.titulo, usuario_id: @noticium.usuario_id } }
